...
export const CommentCard = ({ data }) => {
  ...
  return (
    <div className="rounded-10 border-2 border-accent py-8 px-[10px] md:px-[14px] xl:px-6 flex flex-col gap-3 xl:gap-6 items-center md:w-[216px] xl:w-[414px] min-h-[484px] md:min-h-[736px] xl:min-h-[834px]">
      <Image
        src={photo}
        alt={name}
        quality={100}
